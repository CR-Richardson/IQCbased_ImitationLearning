% Plots mean and standard deviation across training for varying hidden layer widths
clear
...
new_color = 'red'; 
experiment1 = 'size=5_nlayers=2_rho=10_QC=new/size=5_nlayers=2_rho=10_QC=new_';
experiment2 = 'size=10_nlayers=2_rho=10_QC=new/size=10_nlayers=2_rho=10_QC=new_';
experiment3 = 'size=15_nlayers=2_rho=10_QC=new/size=15_nlayers=2_rho=10_QC=new_';
experiment4 = 'size=20_nlayers=2_rho=10_QC=new/size=20_nlayers=2_rho=10_QC=new_';
experiment5 = 'size=25_nlayers=2_rho=10_QC=new/size=25_nlayers=2_rho=10_QC=new_';

% old QC
old_legend = 'Combined sector bound';
old_color = 'blue';
experiment6 = 'size=5_nlayers=2_rho=10_QC=old/size=5_nlayers=2_rho=10_QC=old_';
experiment7 = 'size=10_nlayers=2_rho=10_QC=old/size=10_nlayers=2_rho=10_QC=old_';
experiment8 = 'size=15_nlayers=2_rho=10_QC=old/size=15_nlayers=2_rho=10_QC=old_';
experiment9 = 'size=20_nlayers=2_rho=10_QC=old/size=20_nlayers=2_rho=10_QC=old_';
experiment10 = 'size=25_nlayers=2_rho=10_QC=old/size=25_nlayers=2_rho=10_QC=old_';
...
x = [5, 10, 15, 20, 25]; % width of hidden layers
...
if true
    ...
    grid minor;
    xlim([5, 25]);
    xlabel('Width of hidden layers','interpreter','latex');
    ylabel('$-\log(det(Q1))$','interpreter','latex');
    legend(new_legend, old_legend, '', '', 'Location', 'northeast');
